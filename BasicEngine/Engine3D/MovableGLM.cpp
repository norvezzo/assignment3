...
void MovableGLM::MyLocRot(float angle, const glm::vec3& vec, int mode)
{
	localRot = glm::rotate(localRot, angle, vec);
}
...
glm::mat4 MovableGLM::getLocalRot() {
	return localRot;
}
